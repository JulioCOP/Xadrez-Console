    ...
    class Rei : Peca
    {
        ...
        public override bool[,] movimentosPossiveis()
        {
            ...
            if (qtdMovimentos==0 && !partida.xeque)
            {
                ...
                // #JOGADA ESPECIAL 1 -> ROQUE GRANDE
                // Se assemlhaao roque pequeno, a difereça é que a Torre deve andar 3 casas para a direita e o rei 2 casas para esquerda
                // As regras são as mesmas para ambos os casos
